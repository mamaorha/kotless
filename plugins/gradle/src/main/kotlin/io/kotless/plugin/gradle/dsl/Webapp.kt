...
class Webapp(project: Project) : Serializable {
    ...
    class Graal : Serializable {
         ...
         * FULL_GRAAL_VM_FLAGS = "-H:+UnlockExperimentalVMOptions", "-H:+ReportExceptionStackTraces", "-H:+ReportUnsupportedElementsAtRuntime", "-H:+AllowIncompleteClasspath", "-H:ReflectionConfigurationFiles=/working/build/$DEFAULT_REFLECT_FILE_NAME", "--initialize-at-build-time=kotlinx,kotlin,org.apache.logging.log4j,org.apache.logging.slf4j,org.apache.log4j" + BASE_GRAAL_FLAGS
        */
